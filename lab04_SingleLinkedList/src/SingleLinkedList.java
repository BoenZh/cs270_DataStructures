 ...
 * Name: Zhang Boen
  ...
  Program description: the single linked list!
  Known Bugs: none
  Creativity: none
...
public class SingleLinkedList<E>{
    ...
    /**
     * If you are one of the first three people to email me "I know SLL"
     * before 8:00 AM Tuesday, I will give you 5 in-class bonus points.
     *
...
/*****************************************************************************/
    ...
    public boolean remove(E item) {
    	...
    	while(check==false && sizeCheck<size){
	...
	/**
	 * test if contain or not
	 * @param item for the input E
	 * @return ture if contain item, else return false
	 */
	...
	/**
	 * the frist index of item E
	 * @param item the target
	 * @return the first index of E item in the list, -1 if its not contain
	 */
	...
	/**
	 * check the last index of E item
	 * @param item the E, target
	 * @return the last index of item in the list, -1 if not contain
	 */
